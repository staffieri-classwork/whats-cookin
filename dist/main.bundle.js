...
function onLoadContent() {
  ...
  let promise1 = _api__WEBPACK_IMPORTED_MODULE_6__["default"].getUsers()
  let promise2 = _api__WEBPACK_IMPORTED_MODULE_6__["default"].getRecipes()
  let promise3 = _api__WEBPACK_IMPORTED_MODULE_6__["default"].getIngredients()
...
function generateUser() {
  user = new _user__WEBPACK_IMPORTED_MODULE_1___default.a(users[Math.floor(Math.random() * users.length)]);
...
function createRecipeObject(recipes) { //Still needed? Input? where does this live?
  let newRecipeObjects = recipes.map(recipe => new _recipe__WEBPACK_IMPORTED_MODULE_2___default.a(recipe));
...
function createCards() {
  recipeData.forEach(recipe => {
    let recipeInfo = new _recipe__WEBPACK_IMPORTED_MODULE_2___default.a(recipe);
    let shortRecipeName = recipeInfo.name;
    recipes.push(recipeInfo); // here up one function
    if (recipeInfo.name.length > 40) {
      shortRecipeName = recipeInfo.name.substring(0, 40) + "...";
    } // one function to check and handle recipe name length
    _domUpdates__WEBPACK_IMPORTED_MODULE_5__["default"].addToDom(recipeInfo, shortRecipeName, main) // moved to domUpdates.js
  });
}
